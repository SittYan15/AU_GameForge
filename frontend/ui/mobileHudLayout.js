...
style.textContent = `
    ...
    @media (max-width: 900px) {
        ...
        #campusExplorerPanel {
            ...
            width: min(235px, 56vw) !important;
         ...
         */
        body.au-minigame-focus #campusExplorerDock,
        ...
        body.au-minigame-focus #desktopFullscreenButton,
        ...
        /* -----------------------------------------------------
           Campus Road Race mobile layout
           ----------------------------------------------------- */
        body.au-minigame-focus #carRaceHud {
            top: max(8px, env(safe-area-inset-top)) !important;
            left: max(8px, env(safe-area-inset-left)) !important;
            right: auto !important;
        ...
        body.au-minigame-focus #carRaceReturnButton {
            top: auto !important;
            right: auto !important;
            bottom: calc(12px + env(safe-area-inset-bottom)) !important;
            left: 50% !important;
        ...
        #joystick-zone {
            left: max(36px, env(safe-area-inset-left)) !important;
